...
void commandLine::saveParameters(){
	...
	myfile<<"Forget coefficient for RLS:\t"<<forget<<endl;
...
void commandLine_test()
{
	...
	cout<<endl<<"number of core used= "<<Cl.numCore<<endl;
	cout<<"lambda for RLs= "<<Cl.lambdaRLS;
	cout<<endl<<"forget coefficient for RLS= "<<Cl.forget;
